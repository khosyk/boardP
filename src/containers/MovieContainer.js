...
class GameContainer extends Component {
    ...
    getFirstData = async () => {
        try {
            const result = await axios.get(
                `${config.host}/posts?page=1&type=movie`
            );
    ...
    getCurrentPage = async (e) => {
        ...
        try {
            const result = await axios.get(
                `${config.host}/posts?page=${currentPage}type=movie`
            );
            const {
                data: { contents: contentsData, page },
            } = result;
    ...
    getSearch = async () => {
        try {
            const result = await axios.get(`${config.host}/posts?type=movie`);
            ...
            <MainBlock>
                ...
                <MainTable>
                    ...
                    <TFooter>
                        <TTools>
                            <TSearch>
                                <SearchBtn onClick={this.getSearch}>
                                    검색
                                </SearchBtn>
                                <SearchText
                            ...
                            <Guides>
                                <First onClick={this.getFirstData}>
                                    ■ 처음
                                </First>
                                <Pages>
